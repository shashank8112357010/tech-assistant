...
export function Button({
  ...
  return (
    <Component
      className={cn(
        "relative h-13 w-40 overflow-hidden bg-transparent p-[1px] text-xl",
        containerClassName,
      )}
      style={{
    ...
    >
      ...
      <div
        className={cn(
          "relative flex h-full w-full items-center justify-center border border-slate-800 bg-gradient-to-br from-blue-900/40 via-neutral-950 to-pink-900/30 text-sm text-white antialiased backdrop-blur-xl",
          className,
        )}
        style={{

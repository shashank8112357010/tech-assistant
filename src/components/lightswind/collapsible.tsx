...
        // Cast event to correct type for Button
...
              // Only add onClick if the child is a DOM element (type is string)
              if (typeof child.type === "string") {
                childProps.onClick = (e: React.MouseEvent<Element>) => {
                  handleClick(e);
                  const origOnClick = (child.props as { onClick?: React.MouseEventHandler }).onClick;
